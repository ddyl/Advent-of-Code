"""Test case for the year 2022, day 1."""
...
from advent_of_code.year_2022 import day_1
...
def mock_get_input(mocker: MockFixture) -> Mock:
    ...
    input_file = path.join(
        getcwd(), "tests", "year_2022", "test_inputs", "day_1_input.txt"
    )
