...
from advent_of_code.year_2022 import day_2
...
def mock_get_input(mocker: MockFixture) -> Mock:
    ...
    input_file = path.join(
        getcwd(), "tests", "year_2022", "test_inputs", "day_2_input.txt"
    )
